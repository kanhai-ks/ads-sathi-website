    ...
    >
      ...
      <div className="relative container mx-auto px-6 pt-25 pb-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* IMAGE CARD (About Section Style) */}
          <motion.div
            initial={{ opacity: 0, x: 60 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            <p className="mt-6 text-blue-100 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              ADS SATHI empowers businesses with AI-generated videos,
              professional video editing, social media marketing,
              branding, graphic design and digital advertising solutions.
            </p>
